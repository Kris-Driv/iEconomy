...
class TakeMoneyCommand extends EconomyCommand
{
    ...
    public function execute(CommandSender $sender, $commandLabel, array $args)
    {
        ...
        if($account->isOnline()) {
            $account->getOwner()->sendMessage(($sender instanceof Player ? $sender->getDisplayName() : $sender->getName()).TextFormat::RESET." has taken ".iEconomy::formatMoney($money)." from your account");
        }
